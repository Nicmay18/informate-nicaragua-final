...
<body>
  ...
  ${data.articles.map(article => `
    <div class="article">
      ...
      <p>${article.resumen || ''}</p>
      <a href="${article.slug ? `https://nicaraguainformate.com/noticias/${article.slug}` : `https://nicaraguainformate.com/noticia.html?id=${article.id}`}" class="cta">Leer completo →</a>
    </div>
  `).join('')}
</body>
</html>`;
