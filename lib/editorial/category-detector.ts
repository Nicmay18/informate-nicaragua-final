...
const PATRONES: CategoryPattern[] = [
  ...
  { categoria: 'Cultura', keywords: /\b(?:festival\s+gastron[oó]mico|festival\s+cultural|festival\s+del\s+campo|feria\s+del\s+caballo|gastronom[ií]a|comida\s+t[ií]pica|platillo|sabor|receta|ingredientes|artesan[ií]a|patrimonio\s+cultural|tradici[oó]n|celebraci[oó]n|fiesta\s+patronal|ritual|manifestaci[oó]n|poes[ií]a|poeta|literatura|libro|feria\s+del\s+libro|danza\s+folkl[oó]rica|baile\s+tradicional)\b/i, peso: 3 },
  { categoria: 'Espectáculos', keywords: /\b(?:concierto|festival|cine|pel[ií]cula|documental|cortometraje|teatro|obra|ballet|danza\s+moderna|m[uú]sica\s+pop|cantante|grupo|banda|[aá]lbum|artista|pintor|exposici[oó]n|galer[ií]a|museo|carnaval|comparsa|humorista|stand-?up|telenovela|poes[ií]a\s+urbana|poeta\s+joven|literatura\s+juvenil|libro\s+de\s+autoayuda|Grammy|premio|streaming|Spotify|YouTube|disquera|actor|actriz|productor|director)\b/i, peso: 3 },
  { categoria: 'Turismo', keywords: /\b(?:mirador|mirador\s+de|lugar\s+tur[ií]stico|destino\s+tur[ií]stico|atractivo\s+tur[ií]stico|reserva\s+natural|parque\s+nacional|isla|playa|sendero|calet[oó]n|cañón|cascada|catarina|san\s+juan\s+del\s+sur|ometepe|mombacho|cerro\s+negro|laguna\s+de\s+apoyo|ruta\s+tur[ií]stica|gu[ií]a\s+tur[ií]stica|c[oó]mo\s+llegar|horarios\s+de\s+visita|precio\s+de\s+entrada)\b/i, peso: 3 },
  { categoria: 'Economía', keywords: /\b(?:econom[ií]a|PIB|crecimiento|inflaci[oó]n|exportaci[oó]n|importaci[oó]n|Banco\s+Central|BCN|d[oó]lar|c[oó]rdoba|inversi[oó]n|finanzas|banco|cr[eé]dito|pr[eé]stamo|tasa\s+de\s+inter[eé]s|bolsa|mercado|comercio|Pyme|PYME|empresa|industrial|agroindustria|caf[eé]|az[uú]car|ganader[ií]a|arroz|frijo?l|l[aá]cteos|INTUR|hotel|hosteler[ií]a|aduanas|tratado\s+comercial|Mercosur|canasta\s+b[aá]sica)\b/i, peso: 3 },
