...
const SUCESOS: CategoriaContract = {
  ...
  servicioDefinicion:
    'En Sucesos, "servicio" es: qué investiga la Policía, qué pasa ahora, qué hará Medicina Legal, qué sigue en el proceso, cuándo podría haber resolución.',
  contexto: [
    ...
    { concepto: 'Quiénes', sinonimos: ['víctima', 'víctimas', 'afectado', 'afectados', 'motociclista', 'conductor', 'testigo', 'ocupante', 'fallecido', 'lesionado', 'identificado'] },
  ...
  explicacion: [
    { concepto: 'Causas probables', sinonimos: ['exceso de velocidad', 'perdió el control', 'colisión', 'impacto', 'involucrado', 'estrelló', 'volcó', 'presuntamente', 'versión preliminar', 'testigos señalaron', 'según testigos'] },
    { concepto: 'Consecuencias', sinonimos: ['falleció', 'fallecido', 'lesionado', 'trasladado', 'hospital', 'murió', 'falleció en el lugar', 'recibió atención', 'gravedad'] },
    { concepto: 'Proceso', sinonimos: ['investigación', 'investiga', 'determinar', 'responsabilidad', 'resolución administrativa', 'informe técnico', 'diligencias', 'establecer'] },
  ],
  servicio: [
    { concepto: 'Qué investiga la Policía', sinonimos: ['investiga la policía', 'investiga tránsito', 'determinar responsabilidad', 'diligencias', 'investigaciones correspondientes', 'informe técnico'] },
    { concepto: 'Qué pasa ahora', sinonimos: ['qué pasa ahora', 'qué sigue', 'hasta el momento', 'próximos pasos', 'a la espera de', 'se espera', 'continúan las investigaciones'] },
    { concepto: 'Qué hará Medicina Legal', sinonimos: ['medicina legal', 'valoración médico legal', 'dictamen', 'cuerpo', 'autopsia'] },
  ],
