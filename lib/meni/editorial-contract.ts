...
const SUCESOS: CategoriaContract = {
  ...
  servicioDefinicion:
    'En Sucesos, "servicio" es: qué sigue en la investigación, qué harán las autoridades, qué falta conocer, cómo continúa el proceso y qué peritajes faltan. No exigir teléfonos ni dónde denunciar si el caso no lo requiere.',
  contexto: [
    { concepto: 'Qué ocurrió', sinonimos: ['qué ocurrió', 'cómo ocurrió', 'los hechos', 'el incidente', 'el accidente', 'el caso', 'la situación', 'el hecho ocurrió', 'qué pasó'] },
    { concepto: 'Dónde', sinonimos: ['en', 'lugar', 'municipio', 'barrio', 'km', 'kilometro', 'carretera', 'avenida', 'calle', 'sector', 'reparto', 'comunidad'] },
    ...
    { concepto: 'Autoridades', sinonimos: ['policía', 'transito', 'tránsito', 'medicina legal', 'cruz blanca', 'bomberos', 'socorrista', 'investiga', 'diligencia', 'levantamiento'] },
  ],
  explicacion: [
    { concepto: 'Causas probables', sinonimos: ['exceso de velocidad', 'perdió el control', 'colisión', 'impacto', 'involucrado', 'estrelló', 'volcó', 'presuntamente', 'versión preliminar', 'testigos señalaron', 'según testigos', 'desapareció', 'fue encontrado'] },
    { concepto: 'Consecuencias', sinonimos: ['falleció', 'fallecido', 'lesionado', 'trasladado', 'hospital', 'murió', 'falleció en el lugar', 'recibió atención', 'gravedad', 'encontrado sin vida', 'sin vida'] },
    ...
    { concepto: 'Estado del caso', sinonimos: ['estado del caso', 'investigación abierta', 'continúan las diligencias', 'continúa la investigación', 'no hay personas detenidas', 'causa bajo investigación', 'sigue en desarrollo', 'sigue en curso', 'próximos pasos'] },
  ],
  servicio: [
    { concepto: 'Qué sigue en la investigación', sinonimos: ['qué sigue', 'qué pasará', 'próximos pasos', 'continuará la investigación', 'seguirá la investigación', 'futuras diligencias', 'sigue en desarrollo', 'sigue en curso'] },
    { concepto: 'Qué harán las autoridades', sinonimos: ['qué hará la policía', 'qué harán las autoridades', 'continuará', 'realizará', 'investigará', 'determinará', 'se encargará', 'autoridades continuarán'] },
