...
const SUCESOS: CategoriaContract = {
  ...
  contexto: [
    { concepto: 'Qué ocurrió', sinonimos: ['qué ocurrió', 'cómo ocurrió', 'los hechos', 'el incidente', 'el accidente', 'el caso', 'la situación', 'el hecho ocurrió', 'qué pasó', 'se produjo', 'sucedió'] },
    { concepto: 'Dónde', sinonimos: ['en', 'lugar', 'municipio', 'barrio', 'km', 'kilometro', 'carretera', 'avenida', 'calle', 'sector', 'reparto', 'comunidad', 'departamento'] },
    { concepto: 'Cuándo', sinonimos: ['este', 'ayer', 'la noche', 'la madrugada', 'la tarde', 'la mañana', 'el día', 'la semana', 'hora', 'minutos', 'horas'] },
    { concepto: 'Quiénes', sinonimos: ['víctima', 'víctimas', 'afectado', 'afectados', 'motociclista', 'conductor', 'testigo', 'ocupante', 'fallecido', 'lesionado', 'identificado', 'fue encontrado sin vida', 'encontrado sin vida', 'sin vida', 'sin signos vitales', 'quien falleció', 'involucrados', 'implicados'] },
    { concepto: 'Estado de las víctimas', sinonimos: ['estado de las víctimas', 'estado de los afectados', 'herido', 'heridos', 'fallecido', 'fallecidos', 'lesionado', 'lesionados', 'sin signos vitales', 'encontrado sin vida', 'trasladado', 'hospital', 'recibió atención', 'gravedad', 'estable', 'en observación'] },
    { concepto: 'Autoridades', sinonimos: ['policía', 'transito', 'tránsito', 'medicina legal', 'cruz blanca', 'bomberos', 'socorrista', 'investiga', 'diligencia', 'levantamiento', 'fiscalía', 'autoridades'] },
    ...
    { concepto: 'Qué sigue', sinonimos: ['qué sigue', 'qué pasará', 'próximos pasos', 'continuará la investigación', 'seguirá la investigación', 'futuras diligencias', 'sigue en desarrollo', 'sigue en curso', 'continúa la investigación', 'estado del caso', 'causa bajo investigación'] },
  ],
  explicacion: [
    { concepto: 'Proceso', sinonimos: ['investigación', 'investiga', 'determinar', 'responsabilidad', 'resolución administrativa', 'informe técnico', 'diligencias', 'establecer', 'hay una carta', 'no existe causa oficial', 'aún no se sabe', 'todavía no', 'falta por conocer', 'se desconoce', 'no hay detenidos', 'sin detenidos', 'no existen responsables'] },
    { concepto: 'Estado del caso', sinonimos: ['estado del caso', 'investigación abierta', 'continúan las diligencias', 'continúa la investigación', 'no hay personas detenidas', 'causa bajo investigación', 'sigue en desarrollo', 'sigue en curso', 'próximos pasos', 'qué sigue'] },
  ],
  servicio: [
    ...
    { concepto: 'Qué sigue', sinonimos: ['qué sigue', 'qué pasará', 'próximos pasos', 'continuará la investigación', 'sigue en desarrollo', 'sigue en curso', 'futuras diligencias', 'continúa la investigación', 'estado del caso'] },
  ],
