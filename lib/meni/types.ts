...
export interface MeniResult {
  ...
  finalEditorialScore: number | null;
  estadoFinal: 'APROBADO' | 'MEJORAR' | 'NO_PUBLICAR' | 'EVALUATION_ERROR';
  aprobado: boolean;
  calificacion: string;
  score_status?: 'VALID' | 'INVALID';
  score?: number | null;
  verdict?: 'APROBADO' | 'MEJORAR' | 'NO_PUBLICAR' | 'EVALUATION_ERROR';
  publication_decision?: 'APROBADO' | 'NO_PUBLICAR' | 'NOT_EVALUATED';
  invalidScoreSource?: string;
