...
export const PROFILE_SIGNALS: Record<MeniContentProfile, ProfileSignal[]> = {
  ...
  nacionales: [
    ...
    { keyword: 'alcaldia', weight: 1 },
    { keyword: 'ministerio', weight: 1 },
    { keyword: 'institución', weight: 0.5 },
    { keyword: 'institucion', weight: 0.5 },
    { keyword: 'inss', weight: 3 },
    { keyword: 'seguro social', weight: 2 },
    { keyword: 'pensión', weight: 1.5 },
    { keyword: 'pension', weight: 1.5 },
    { keyword: 'prestación', weight: 1.2 },
    { keyword: 'prestacion', weight: 1.2 },
    { keyword: 'beneficio', weight: 1.2 },
    { keyword: 'subsidio', weight: 1.2 },
    { keyword: 'indemnización', weight: 1.2 },
    { keyword: 'indemnizacion', weight: 1.2 },
    { keyword: 'familiares', weight: 0.8 },
    { keyword: 'protege', weight: 1.5 },
    { keyword: 'protección', weight: 1.2 },
    { keyword: 'proteccion', weight: 1.2 },
    { keyword: 'derechos', weight: 1 },
    { keyword: 'requisitos', weight: 1.2 },
    { keyword: 'trámites', weight: 1.5 },
    { keyword: 'tramites', weight: 1.5 },
    { keyword: 'como solicitar', weight: 1.5 },
    { keyword: 'cómo solicitar', weight: 1.5 },
    { keyword: 'solicitud', weight: 1 },
    { keyword: 'fallecimiento', weight: 1 },
  ],
  politica: [
