...
const REGISTRY: Record<string, CeoActionDefinition> = {
  ...
  'queue-editorial-plan': {
    id: 'queue-editorial-plan',
    domain: 'content',
    level: 4,
    title: 'Planificar contenido para categoría deficitaria',
    risk: 0.4,
    reversible: true,
    requiresHuman: true,
    executor: 'nios-queue',
    verification: 'Tarea en nios_memory con la categoría y la desviación detectada.',
    sideEffect: 'Encola una tarea editorial; no crea ni publica contenido.',
    description: 'Sugiere cubrir el déficit de una categoría frente al objetivo editorial.',
  },
