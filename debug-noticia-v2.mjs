...
console.log('Imagen:', n.imagenDestacada ? n.imagenDestacada.substring(0, 60) : 'NO');
...
// Versión simplificada de citas (sin regex problemático)
...
console.log('Citas:', tieneCitas, '| Atribuciones:', atribuciones, '| Blockquotes:', blockquotes, '| PassCitas:', passCitas);
