...
async function main() {
  console.log('📡 Verificando palabras de las 5 noticias corregidas...\n');
  ...
  for (const id of ids) {
    ...
    if (snap.exists()) {
      ...
      const estado = palabras >= 350 ? '✅ OK' : '🔴 FALTAN PALABRAS';
      console.log(`${estado} ${n.titulo.substring(0, 45)}... (${palabras} palabras)`);
    }
  }
}
