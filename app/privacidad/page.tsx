  ...
  return (
    <LegalPageShell title="Política de Privacidad">
      ...
      <p style={{ color: '#64748b', marginBottom: '1.5rem', lineHeight: 1.75, fontSize: '0.92rem' }}>
        <strong>Nicaragua Informate</strong> es un medio digital con sede en Managua, Nicaragua. Para cualquier consulta sobre esta política, escríbenos a <a href="mailto:contacto@nicaraguainformate.com" style={{ color: '#2563eb', textDecoration: 'none', fontWeight: 600 }}>contacto@nicaraguainformate.com</a>.
      </p>

      <h2 style={{ fontSize: '1.2rem', color: '#0f172a', marginTop: '2.5rem', marginBottom: '0.75rem', fontWeight: 700 }}>2. ¿Qué datos recopilamos?</h2>
      ...
      <p style={{ color: '#64748b', marginBottom: '1.25rem', lineHeight: 1.75, fontSize: '0.92rem' }}>
        Utilizamos <strong style={{ color: '#0f172a' }}>Monetag</strong> para mostrar anuncios en nuestro sitio. Monetag puede usar cookies y tecnologías similares para personalizar la publicidad que ves.
      </p>
      <p style={{ color: '#64748b', marginBottom: '1.5rem', lineHeight: 1.75, fontSize: '0.92rem' }}>
      ...
      <h2 style={{ fontSize: '1.2rem', color: '#0f172a', marginTop: '2.5rem', marginBottom: '0.75rem', fontWeight: 700 }}>7. Cambios en esta política</h2>
      <p style={{ color: '#64748b', marginBottom: '1.5rem', lineHeight: 1.75, fontSize: '0.92rem' }}>
