  ...
  return (
    <LegalPageShell title="Política de Correcciones">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: '0.75rem', margin: '1.25rem 0 1.5rem' }}>
        {[
          ...
          <div key={s.step} style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 10, padding: '1rem' }}>
            <div style={{ width: 28, height: 28, borderRadius: '50%', background: 'linear-gradient(135deg,#8c1d18,#c41e3a)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#0f172a', fontWeight: 700, fontSize: 13, marginBottom: 10 }}>{s.step}</div>
      ...
      <div style={{ background: 'rgba(251,191,36,0.08)', border: '1px solid rgba(251,191,36,0.25)', borderRadius: 10, padding: '1.25rem', marginBottom: '1.5rem' }}>
        ...
        <p style={{ color: '#475569', margin: 0, fontSize: '0.88rem', lineHeight: 1.65 }}>
      ...
      <ul style={{ marginLeft: '1.5rem', marginBottom: '1.5rem', color: '#475569', fontSize: '0.92rem', lineHeight: 1.8 }}>
        <li style={{ marginBottom: '0.5rem' }}>Nuestro <Link href="/contacto" style={{ color: '#2563eb', textDecoration: 'none' }}>formulario de contacto</Link> seleccionando “Solicitar corrección”</li>
      ...
      <ul style={{ marginLeft: '1.5rem', marginBottom: '1.5rem', color: '#475569', fontSize: '0.92rem', lineHeight: 1.8 }}>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#0f172a' }}>Corrección mayor:</strong> afecta hechos centrales de la nota (cifras, identidades, fechas decisivas). Se incluye nota de corrección destacada y se actualiza el titular si es necesario.</li>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#0f172a' }}>Corrección menor:</strong> errores secundarios (ortografía de un apellido, año de un evento, número de víctimas no central a la nota). Se rectifica y se anota brevemente.</li>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#0f172a' }}>Aclaración:</strong> agrega información que precisa o contextualiza la nota original, sin que necesariamente hubo un error.</li>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#0f172a' }}>Actualización:</strong> añade hechos posteriores que cambian el desarrollo de la historia. Se identifica con la fecha del nuevo dato.</li>
      </ul>
      ...
      <p style={{ color: '#475569', marginBottom: '1.25rem', fontSize: '0.92rem', lineHeight: 1.7 }}>
        Toda persona natural o jurídica que se considere afectada por información publicada en Nicaragua Informate tiene derecho a ejercer la <strong style={{ color: '#0f172a' }}>réplica</strong>. Para ello, debe enviar una comunicación firmada a <a href="mailto:legal@nicaraguainformate.com" style={{ color: '#2563eb', textDecoration: 'none' }}>legal@nicaraguainformate.com</a> indicando: (i) el artículo concreto al que se refiere, (ii) los datos específicos que considera incorrectos o lesivos y (iii) la versión corregida o la aclaración que solicita publicar.
      </p>
      <p style={{ color: '#475569', marginBottom: '1.25rem', fontSize: '0.92rem', lineHeight: 1.7 }}>
