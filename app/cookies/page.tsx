  ...
  return (
    <LegalPageShell title="Política de Cookies">
      ...
      <ul style={{ marginLeft: '1.5rem', marginBottom: '1.5rem', color: '#475569', fontSize: '0.92rem', lineHeight: 1.8 }}>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#0f172a' }}>Google AdSense:</strong> Para mostrar publicidad personalizada y medir el rendimiento de los anuncios.</li>
      ...
      <div style={{ background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: 10, padding: '1.25rem', marginBottom: '1.5rem' }}>
        <h3 style={{ fontSize: '0.95rem', color: '#2563eb', fontWeight: 600, marginBottom: '0.75rem' }}>Google AdSense y publicidad personalizada</h3>
        <p style={{ color: '#475569', fontSize: '0.9rem', lineHeight: 1.7 }}>
          ...
          <a href="https://adssettings.google.com" target="_blank" rel="noopener noreferrer" style={{ color: '#2563eb', textDecoration: 'underline' }}>Configuración de anuncios de Google</a>.
        </p>
      </div>
      ...
      <ul style={{ marginLeft: '1.5rem', marginBottom: '1.5rem', color: '#475569', fontSize: '0.92rem', lineHeight: 1.8 }}>
        ...
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#0f172a' }}>Google Ad Settings:</strong> Gestiona tus preferencias de publicidad personalizada en{' '}
          <a href="https://adssettings.google.com" target="_blank" rel="noopener noreferrer" style={{ color: '#2563eb', textDecoration: 'none' }}>adssettings.google.com</a>.</li>
