...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.nicaraguainformate.com/cookies' },
};
...
const COOKIE_TYPES = [
  ...
  },
  {
    ...
    description: 'Utilizadas por Google AdSense para mostrar anuncios relevantes basados en tus intereses.',
...
export default function CookiesPage() {
  return (
    <LegalPageShell title="Política de Cookies">
      <div style={{ background: 'rgba(251,191,36,0.08)', borderLeft: '4px solid #fbbf24', padding: '0.75rem 1.25rem', borderRadius: '0 0.5rem 0.5rem 0', marginBottom: '2rem', color: '#94a3b8', fontSize: '0.85rem' }}>
      ...
      <h2 style={{ fontSize: '1.2rem', color: '#fff', marginTop: '2.5rem', marginBottom: '0.75rem', fontWeight: 700 }}>1. ¿Qué son las cookies?</h2>
      ...
      <h2 style={{ fontSize: '1.2rem', color: '#fff', marginTop: '2.5rem', marginBottom: '0.75rem', fontWeight: 700 }}>2. Tipos de cookies que utilizamos</h2>
      
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '1.5rem' }}>
        {COOKIE_TYPES.map((cookie, index) => (
          <div key={index} style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '1.25rem' }}>
            <h3 style={{ fontSize: '1rem', color: '#fbbf24', fontWeight: 600, marginBottom: '0.5rem' }}>{cookie.name}</h3>
            <p style={{ color: '#94a3b8', fontSize: '0.9rem', lineHeight: 1.6, marginBottom: '0.5rem' }}>{cookie.description}</p>
      ...
      <h2 style={{ fontSize: '1.2rem', color: '#fff', marginTop: '2.5rem', marginBottom: '0.75rem', fontWeight: 700 }}>3. Cookies de terceros</h2>
      ...
      <ul style={{ marginLeft: '1.5rem', marginBottom: '1.5rem', color: '#cbd5e1', fontSize: '0.92rem', lineHeight: 1.8 }}>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#fff' }}>Google AdSense:</strong> Para mostrar publicidad personalizada y medir el rendimiento de los anuncios.</li>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#fff' }}>Google Analytics:</strong> Para analizar el tráfico del sitio y entender el comportamiento de los usuarios.</li>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#fff' }}>Firebase:</strong> Para el funcionamiento de la base de datos en tiempo real de noticias.</li>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#fff' }}>Open-Meteo:</strong> Para proporcionar información meteorológica localizada.</li>
      </ul>
      ...
      <div style={{ background: 'rgba(96,165,250,0.08)', border: '1px solid rgba(96,165,250,0.25)', borderRadius: 10, padding: '1.25rem', marginBottom: '1.5rem' }}>
        <h3 style={{ fontSize: '0.95rem', color: '#60a5fa', fontWeight: 600, marginBottom: '0.75rem' }}>Google AdSense y publicidad personalizada</h3>
        <p style={{ color: '#cbd5e1', fontSize: '0.9rem', lineHeight: 1.7 }}>
          Utilizamos Google AdSense para mostrar anuncios en nuestro sitio. Google utiliza cookies para personalizar 
      ...
      <h2 style={{ fontSize: '1.2rem', color: '#fff', marginTop: '2.5rem', marginBottom: '0.75rem', fontWeight: 700 }}>4. Gestión de cookies</h2>
      <p style={{ color: '#cbd5e1', marginBottom: '1rem', fontSize: '0.92rem', lineHeight: 1.7 }}>
        Puedes controlar y gestionar las cookies de varias formas:
      </p>
      <ul style={{ marginLeft: '1.5rem', marginBottom: '1.5rem', color: '#cbd5e1', fontSize: '0.92rem', lineHeight: 1.8 }}>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#fff' }}>Configuración del navegador:</strong> La mayoría de los navegadores permiten bloquear o eliminar cookies. Consulta la sección de ayuda de tu navegador para más información.</li>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#fff' }}>Google Ad Settings:</strong> Gestiona tus preferencias de publicidad personalizada en{' '}
          <a href="https://adssettings.google.com" target="_blank" rel="noopener noreferrer" style={{ color: '#60a5fa', textDecoration: 'none' }}>adssettings.google.com</a>.</li>
        <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#fff' }}>Your Online Choices:</strong> Opciones para gestionar publicidad de terceros en{' '}
          <a href="https://www.aboutads.info" target="_blank" rel="noopener noreferrer" style={{ color: '#60a5fa', textDecoration: 'none' }}>www.aboutads.info</a>.</li>
      </ul>

      <h2 style={{ fontSize: '1.2rem', color: '#fff', marginTop: '2.5rem', marginBottom: '0.75rem', fontWeight: 700 }}>5. Impacto de desactivar cookies</h2>
      <p style={{ color: '#cbd5e1', marginBottom: '1.25rem', fontSize: '0.92rem', lineHeight: 1.7 }}>
      ...
      <h2 style={{ fontSize: '1.2rem', color: '#fff', marginTop: '2.5rem', marginBottom: '0.75rem', fontWeight: 700 }}>6. Consentimiento</h2>
      <p style={{ color: '#cbd5e1', marginBottom: '1.25rem', fontSize: '0.92rem', lineHeight: 1.7 }}>
      ...
      <h2 style={{ fontSize: '1.2rem', color: '#fff', marginTop: '2.5rem', marginBottom: '0.75rem', fontWeight: 700 }}>7. Actualizaciones de esta política</h2>
      <p style={{ color: '#cbd5e1', marginBottom: '1.25rem', fontSize: '0.92rem', lineHeight: 1.7 }}>
      ...
      <h2 style={{ fontSize: '1.2rem', color: '#fff', marginTop: '2.5rem', marginBottom: '0.75rem', fontWeight: 700 }}>8. Contacto</h2>
