...
const NOTICIAS = [
  {
    buscar: ['motociclista fallece', 'jinotega', 'colisión'],
  ...
  {
    buscar: ['joven desaparece', 'laguna de xiloá', 'xiloa'],
  ...
  {
    buscar: ['carlos vives', 'maluma', 'premiación', 'gala'],
  ...
  {
    buscar: ['shakira', 'dos millones', 'copacabana', 'concierto'],
  ...
  {
    buscar: ['berman espinoza', 'récord', 'ponches', 'béisbol'],
  ...
  {
    buscar: ['repatrían', 'cuerpo', 'miami', 'nicaragüense'],
  ...
  {
    buscar: ['siniestro estructural', 'mercado oriental', 'managua'],
  ...
  {
    buscar: ['electrocución', 'accidentes laborales', 'disnorte', 'dissur'],
    titulo: 'Obrero fallece por descarga eléctrica en Managua',
    cat: 'Sucesos', dep: 'Managua', dateline: 'MANAGUA',
    slug: 'obrero-fallece-descarga-electrica-managua',
    html: `<h2>Hechos principales</h2><p>Un obrero subcontratado falleció por descarga eléctrica mientras realizaba labores en el tendido eléctrico en la comarca <strong>Chiquilistagua</strong>, carretera vieja a <strong>León</strong>, <strong>Managua</strong>. El trabajador se encontraba en una estructura cuando ocurrió el contacto con cables energizados.</p><p>Efectivos de <strong>Bomberos Unidos</strong> y cuerpos de socorro acudieron al sitio, pero el obrero ya había fallecido. Las autoridades iniciaron investigaciones para determinar las circunstancias exactas del accidente.</p><h2>Desarrollo</h2><p>La víctima laboraba para una empresa subcontratada por <strong>Disnorte-Dissur</strong> en labores de mantenimiento de redes eléctricas. Compañeros de trabajo presenciaron el momento del accidente y dieron aviso a las autoridades.</p><p>Este deceso se suma a una serie de accidentes por contacto con corriente eléctrica registrados durante el año en el territorio nacional. Según registros de medios locales, al menos <strong>28 personas</strong> han fallecido por este tipo de incidentes en lo que va del año.</p><p>La <strong>Policía Nacional</strong> y peritos de la <strong>Dirección de Auxilio Judicial</strong> levantaron evidencias en el lugar para determinar responsabilidades. El cuerpo fue remitido al <strong>Instituto de Medicina Legal</strong> para autopsia.</p><p>Pie de Foto: Red eléctrica en zona residencial de Managua. Foto: Cortesía.</p>`
  }
];
...
async function main() {
  ...
  for (const n of NOTICIAS) {
    ...
    const data = {
      titulo, contenido, categoria: n.cat, departamento: n.dep, dateline: n.dateline,
      resumen, slug: n.slug, imagenDestacada: true,
