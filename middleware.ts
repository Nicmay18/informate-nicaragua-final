...
export function middleware(request: NextRequest) {
  ...
  if (pathname.startsWith('/api/admin/')) {
    const PUBLIC_ADMIN_ROUTES = ['/api/admin/session', '/api/admin/estado', '/api/admin/config', '/api/admin/phase15-2-dup-audit', '/api/admin/phase15-1-auto-fix'];
