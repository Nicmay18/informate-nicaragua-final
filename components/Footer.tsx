        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <nav className="footer-social-nav" aria-label="Redes sociales">
              ...
              <a href="https://whatsapp.com/channel/0029VbBxKdvDTkKB9SpIwS17" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en WhatsApp" className="footer-social-link" title="WhatsApp">
              ...
              <a href="https://t.me/fHHjncJqMQM3NjZh" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en Telegram" className="footer-social-link" title="Telegram">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
